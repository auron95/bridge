...
\paragraph{Sviluppo dopo 1 \h/\s\ - 2 \sa (Jensen).} Dopo 1 \s\ - P - 2 \sa, l'apertore licita come segue.
\begin{twocol}
	3 \c & 12-15 HCP.\\
...
\paragraph{Sviluppi dopo 1 \h/\s\ - 2 \c (Drury).} Dopo P - P - 1 \s - P - 2 \c, l'apertore licita come segue.
