...
\begin{twocol}
	% 3 \c & Interesse di slam. Obbliga a dire 3 \d, dopodiché il rispondente fissa l'atout con 3 \h o 3 \s e iniziano le cue-bid.
	3 \d & Transfer per le \h, 8 HCP oppure interesse di slam a \h. \\
	3 \h & Transfer per le \s, 8 HCP oppure interesse di slam a \s. \\
	4 \d & Transfer per le \h, 9+ HCP senza interesse di slam. \\
	4 \h & Transfer per le \s, 9+ HCP senza interesse di slam. \\
\end{twocol}

Dopo 3 \d/\h, l'apertore licita 3 \h/\s (passabile) con mano minima, e fa una cue-bid con mano massima. Dopo 4 \d/\h, l'apertore licita 4 \h/\s (a giocare).
