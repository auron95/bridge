...
Se l'avversario di destra ha passato, il compagno del contrante licita come segue.
\begin{itemize}
  \item Colore a livello: fino a 7-8 HCP.
  \item Colore a salto: 9+ HCP.
  \item 1 \sa: 10+ HCP, mano circa bilanciata, fermo nel colore dell'avversario.
\end{itemize}
