...
\begin{itemize}
 ...
 Sulle aperture di 1 \c e 1 \d, se il rispondente ha entrambe le quinte nobili e 8+ HCP può licitare 2 \d (richiesta di terze nobili). Seguono le risposte.
 \begin{twocol}
  2 \h & 12-15 HCP, almeno 3 carte di \h/\s.\\
  2 \sa & 14-15 HCP, nessuna terza nobile.\\
  3 \c/\d & 12-13 HCP, naturale.\\
  3 \h/\s & 16+ HCP, almeno 3 carte di \h/\s.\\
  3 \sa & 16+ HCP, nessuna terza nobile.
 \end{twocol}
\end{itemize}
...
\begin{twocol}
 ...
 3 \c  & 6-7 HCP, fit almeno quarto.\\
 3 \d  & 8-9 HCP, fit almeno quarto.\\
 3 \j  & 0-5 HCP, fit almeno quarto (non è obbligatorio, specialmente se uno o entrambi gli avversari hanno passato).\\
...
Ai fini delle richieste d'Assi e di Re, il K di atout \`e considerato un Asso. In questo caso quindi ci sono 5 Assi e 3 Re. Seguono le risposte alla richiesta d'Assi (4 \sa) nel caso in cui l'atout sia un colore nobile.
\begin{twocol}
5 \c & 1 o 4 Assi.\\
5 \d & 0 o 3 Assi.\\
...
\begin{twocol}
	...
	Colore a livello & colore quarto (se possibile, altrimenti il colore più lungo), 0-8 HCP. \\
	Colore a salto & colore quarto, 9+ HCP, forzante. \\
	Colore a doppio salto & colore quinto, 12+ HCP, forzante. Mai a livello di 4. \\
