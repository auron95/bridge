...
\begin{itemize}
 ...
 Il caso in cui l'apertore apre di 1 \c e poi ripete le \c è tuttavia un po' particolare (perché la prima dichiarazione garantisce solo 2 carte a \c). \note{Vale forse la pena di analizzare un po' questi casi, perché comunque si possono dedurre un bel po' di informazioni.}
 ...
 Se, dopo 1 \h\ - 1 \sa, l'apertore ha 16+ HCP e solo 4 carte di \s, non può dire \hbox{2 \s} (dice 3 \h con almeno 6 carte di \h, 3 \j con un minore \j almeno quarto, altrimenti 2 \sa o 3 \sa a seconda dei punti -- dicendo 2 \sa rinuncia a dare Rever e invita a 3 \sa).
 \note{È forse meglio decidere che 2 \s lo si può dire anche con solo 4 carte di \s? Perché nel caso tra parentesi qua sopra si rischia di dichiarare male. O forse è meglio dire che 3 \c è Rever ma senza necessariamente avere le \c, tanto a nessuno interessano le \c. Quest'ultima possibilità è quella che mi piace di più (bruttissimo dire 2 \s con solo 4 carte, se sai che il tuo compagno ne ha meno di 4!), però vorrei sentire il parere di Ugo.}
 ...
 \item {\bf Solo per l'apertore:} dopo una risposta a livello di 1, superare strettamente 2 \j (dove \j è il colore di apertura) dà Rever, e va fatto se e solo se si hanno 16+ HCP.
 ...
 \note{Indagare casi come 1\h\ - 1 \sa\ - 2 \sa\, / 3 \sa, che dovrebbero essere rispettivamente invitante manche e Rever a SA (il secondo caso dovrebbe essere il fall-back per l'apertura 5-3-3-2 da 18-19 HCP).}
\end{itemize}
