...
\begin{twocol}
 ...
 2 \M & 6-10 HCP, \M almeno quinto e un seme minore laterale almeno quarto.\\
...
In caso di nobile esattamente quinto, il rispondente licita 2 \sa con mano invitante, 3 \sa con mano forzante manche: l'apertore sceglie se giocare a \sa o ad atout.
...
Dopo la sequenza 2 \c\ - 2 \d\ - 2 \sa (23+ HCP, mano bilanciata), si applicano le convenzioni presenti sull'apertura diretta di 2 \sa (Transfer, Puppet Stayman).
...
\begin{twocol}
	...
	4 \M & Richiesta d'Assi con atout \M.\\
	4 \sa & TODO: Decidere come usare questo slot e altro a livello di 5.\\ %TODO
	5 \c & Gerber.
\end{twocol}
...
\begin{twocol}
	...
	5 \c & Gerber.\\
	& TODO: decidere come usare altri slot a livello di 5. %TODO
\end{twocol}
...
\section{Riapetura da secondo di mano}

Dopo la sequenza 1 \h\ - P - 2 \h\ - P - P, il secondo di mano con 6-10 HCP può licitare come segue.

\biddingtable{1 \h & P & 2 \h & P \\ P & * &&}
\begin{twocol}
	Contre & Mano bicolore, \s almeno quarte.\\
	2 \s & Monocolore minore almeno sesto.\\
	2 \sa & Bicolore \c/\d almeno 5/4.\\
	3 \c & Bicolore \d/\c almeno 5/4.\\
\end{twocol}
...
\begin{twocol}
	...
	2 \sa & 9-10 HCP, bicolore minore almeno 5/4.\\
	3 \m & 9-10 HCP, bicolore \m/\h almeno 5/4.\\
	3 \h & 9-10 HCP, bicolore \h/minore almeno 5/4. Il compagno può passare, licitare 3 \s (richiesta del minore) o 3 \sa (a giocare).
\end{twocol}
