...
\begin{twocol}
 ...
 3 \c & \c quinte, senza fit.\\
 3 \h & Fit a \h, 16-18 HCP, invitante.\\
 3 \d\ / 3 \s\ / 4 \c & Cue-bid. 19+ HCP, fit a \h, forzante manche.\\
\end{twocol}

\noindent Se il rispondente aveva licitato 1 \s, semplicemente si scambiano i ruoli di \h e \s (escludendo la risposta 2 \s e inserendo al suo posto 2 \h).
\smallspace
...
Sulle sottoaperture le Cue-bid si iniziano solo a salto. Dichiarare 4 \sa sottintende il seme dell'apertore come atout. Ogni altra dichiarazione a colore è naturale e forzante 1 giro.
