...
\author{Ugo Bindini, Cristoforo Caffi, Alice Cortinovis, Giovanni Paolini, Francesco Veneziano}
...
\paragraph{Sviluppo dopo 1 \h/\s\ - 2 \sa (Jensen).} Dopo 1 \s\ - P - 2 \sa, l'apertore licita
\begin{twocol}
	3 \c & 12-15 HCP.\\
...
\paragraph{Sviluppi dopo 1 \h/\s\ - 2 \c (Drury).}
\begin{twocol}
  2 \d & Artificiale: normale forza di apertura, anche minima; forzante fino a 2M.\\
  2 \h/\s & 
  3 \sa & Senza singoli né vuoti, disponibile a giocare \sa.\\
  Altro & Singolo o vuoto (il più economico).
\end{twocol}
