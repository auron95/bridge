...
\author{Ugo Bindini, Cristoforo Caffi, Alice Cortinovis, Giovanni Paolini}
...
Se possibile, dire un colore almeno quarto a livello di 1 -- il più lungo, e in caso di parità come da algoritmo generale. Attenzione al caso di una mano bicolore \s/\h (vedi oltre). Altrimenti, si licita come segue.
...
\begin{twocol}
  ...
  2 \d & Mano debole o debolissima (0-5 HCP), un seme nobile almeno sesto. L'apertore può licitare 2 \h (passa o correggi). \\
  2 \h & 5-8 HCP, 5+ \s e 4+ \h. \\
  2 \s & 9-11 HCP, 5+ \s e 4+ \h. \\
  2 \sa & 10-11 HCP, invitante a 3 \sa (\c almeno quarte).
\end{twocol}

Su 1 \d:
\begin{twocol}
  1 \sa & 5-11 HCP, senza quarte licitabili a livello di 1. \\
  ...
  2 \sa & 10-11 HCP, invitante a 3 \sa.
\end{twocol}
...
\begin{twocol}
  1 \sa & $\leq 11$ HCP. \\
  2 \c & Forzante manche. \\
  2 \d & Forzante manche, \d almeno quarte.
\end{twocol}
...
\paragraph{Dopo il terzo colore licitato a livello di 1.} Per esempio: 1 \c\ - 1 \d\ - 1 \s. L'apertore non ha rever, quindi ha 12-15 HCP. Se il rispondente vuole dare il fit nel secondo colore \j licitato dall'apertore (che è nobile!), dichiara:
\begin{twocol}
  Pass & $\leq$ 8 HCP.\\
...
Licitare il quarto colore è richiesta di fermo (forzante un giro).
...
\begin{twocol}
  ...
  2 \sa & 10-11 HCP, come nel caso senza fit. \\
  3 \c & 5-9 HCP (l'apertore può passare, proseguire con una cue-bid a \c, chiudere a 3 \sa).
\end{twocol}

\subsection{Con fit sulle \d}

Nota: dopo l'apertura di 1 \d, l'eventuale fit quarto del rispondente viene momentaneamente taciuto.

\begin{twocol}
  1 \h/\s & Se possibile, come nel caso senza fit. \\
  2 \c & 12+ HCP, come nel caso senza fit. \\
  2 \sa & 10-11 HCP, come nel caso senza fit. \\
  3 \d & 5-9 HCP (l'apertore può passare, proseguire con una cue-bid a \c, chiudere a 3 \sa).
\end{twocol}

\subsection{Con fit su un colore maggiore \j}
\begin{twocol}
	2 \j  & 5-8 HCP, fit terzo.\\ 
	2 \sa & 10+ HCP, fit almeno terzo (Jacoby).\\
	3 \c  & 5-8 HCP, fit almeno quarto.\\
	3 \d  & 5-8 HCP, fit almeno quarto.\\
	3 \j  & A sfavore di zona, 5-8 HCP, fit almeno quarto. A favore di zona, 0-5 HCP, fit almeno quarto (barrage). \\
	4 \j  & 5-8 HCP, fit almeno quinto.\\
...
Su 1 \h\ - 2 \sa, le risposte sono analoghe ma è escluso 4 \s.


\section{Dopo una risposta a livello di 1}
