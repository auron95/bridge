...
\begin{twocol}
	2 \j  & Fit terzo, mano non invitante.\\ 
	2 \sa & Fit almeno terzo (Jacoby), mano almeno invitante.\\
	3 \j  & Fit almeno quarto (barrage). \\
	4 \j  & Fit almeno quinto (barrage).\\
	Cue-bid & Fit almeno terzo, forzante manche. Le Cue-bid partono da 3 \h/\s.
\end{twocol}

\paragraph{Sviluppo su 2 \sa.} Su 1 \s\ - 2 \sa, l'apertore licita
\begin{twocol}
	3 \c & 12-15 HCP.\\
...
Su 1 \h\ - 2 \sa, le sequenze sono analoghe (è esclusa la risposta di 4 \s al terzo giro). 
...
\begin{twocol}
  ...
  2 \d & Mano debole o debolissima (0-4 HCP), un seme nobile almeno sesto. L'apertore può licitare 2 \h (passa o correggi). \\
